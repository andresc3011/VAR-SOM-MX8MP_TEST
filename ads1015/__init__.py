...
class ADS1015:
    def __init__(self, i2c_addr=I2C_ADDRESS_DEFAULT, alert_pin=None, i2c_bus=2):
        self._lock = Lock()
        self._is_setup = False
        self._i2c_addr = i2c_addr
        self._i2c_dev = smbus2.SMBus(i2c_bus)
    ...
    def get_reference_voltage(self):
        value = self.get_voltage(channel="in3/gnd")
        return value, 
    ...
    def get_compensated_voltage(
        ...
        pin_v, null = self.get_voltage(channel=channel)
